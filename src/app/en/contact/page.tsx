          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="container mx-auto px-4 text-center">
              ...
              <p className="mt-4 text-white/80 max-w-md mx-auto text-lg">
                Have a question? Book or ask us anything.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 md:py-28">
        <div className="container mx-auto px-4">
          ...
          <p className="text-white/60 text-center mb-6 max-w-lg mx-auto">
            Book your limousine or request a quote. We respond quickly.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6 max-w-2xl mx-auto">
            <a
              href="tel:0699717759"
              className="flex-1 w-full sm:w-auto flex items-center justify-center gap-3 px-8 py-4 rounded-2xl border-2 border-white/20 bg-white/5 text-white font-semibold text-lg hover:border-[#DE27A6]/50 hover:bg-[#DE27A6]/10 transition-all"
            >
